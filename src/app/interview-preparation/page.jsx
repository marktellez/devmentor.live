      ...
      <section className="py-24 sm:py-32">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div
              variants={item}
              className="border border-teal-500/20 p-8 rounded-lg bg-white/[0.02]"
            >
            ...
            <motion.div
              variants={item}
              className="border border-green-500/20 p-8 rounded-lg bg-white/[0.02]"
            >
      ...
      <section className="py-24 sm:py-32 bg-white/[0.02]">
        <div className="container mx-auto px-4">
          ...
          >
            <motion.div
              variants={item}
              className="border border-white/10 p-8 rounded-lg bg-white/[0.02] hover:bg-white/[0.04] transition-colors"
            >
